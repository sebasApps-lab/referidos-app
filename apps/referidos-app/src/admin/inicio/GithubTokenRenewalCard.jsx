...
const STORAGE_KEY = "admin.versioning.github_deploy_token.last_renewed_at";
...
export default function GithubTokenRenewalCard() {
      ...
      <div className="mt-3 grid gap-3 sm:grid-cols-[220px_1fr]">
        ...
        <div className="rounded-xl border border-[#E9E2F7] bg-[#FAF8FF] px-3 py-2">
          {computed.hasDate ? (
            ...
            <div className="text-xs text-slate-600">
              Aun no registras la fecha de renovacion. Guarda una fecha o usa <strong>Renovado hoy</strong>.
            </div>
          )}
          {savedMessage ? (

  ...
  return (
    <div className="relative w-full max-w-sm">
      <AuthCard className="p-6">
        {error ? (
          <ErrorBanner message={error} className="mb-3 text-center" />
        ) : null}

        <div className="space-y-4">
          <AuthHeader
            title="Elige como continuar..."
            subtitle="Si ya tienes cuenta, elige una opcion y entraras automaticamente."
          ...
          <div className="flex items-center gap-3 text-xs text-gray-400">
            <span
              ...
              style={{
                background:
                  "linear-gradient(270deg, rgba(173, 173, 173, 0.9) 0%, rgba(209,213,219,0.75) 95%, rgba(194, 194, 194, 0.2) 100%)",
              }}
            />
            ...
            <span
              ...
              style={{
                background:
                  "linear-gradient(90deg, rgba(173, 173, 173, 0.9) 0%, rgba(209,213,219,0.75) 95%, rgba(194, 194, 194, 0.2) 100%)",
              }}
            />
          </div>
...
function MailIcon() {
  return (
    ...
    >
      ...
      />
      <path
        d="M4 7l7.82 6.165a2 2 0 002.36 0L22 7"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinecap="round"
      />

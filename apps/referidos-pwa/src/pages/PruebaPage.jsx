...
function LogoMark() {
  return (
    <svg viewBox="0 0 57 44" aria-hidden="true">
      <defs>
        <linearGradient id="qrew-mark" x1="3" x2="46" y1="5" y2="38" gradientUnits="userSpaceOnUse">
...
function FauxSelect({ text, width = "auto" }) {
  return (
    <div className="prueba-select" style={{ width }}>
      <span>{text}</span>
      <IconChevron />
    </div>
  );
...
export default function PruebaPage() {
  return (
    <div className="prueba-page">
      <header className="prueba-topbar">
        <div className="prueba-topbar__left">
          <div className="prueba-brand">
            <LogoMark />
            <span>Qrew</span>
          </div>
          <div className="prueba-divider" />
          <div className="prueba-title">Panel de promociones</div>
          <nav className="prueba-mainnav" aria-label="Secciones">
            <a className="is-active" href="/prueba">Crear</a>
            <a href="/prueba">Gestionar</a>
            <a href="/prueba">Métricas</a>
          </nav>
        </div>

        <div className="prueba-topbar__right">
          <button className="prueba-icon-button prueba-notify" type="button" aria-label="Notificaciones">
            <IconBell />
            <span className="prueba-badge">3</span>
          </button>
          <button className="prueba-icon-button" type="button" aria-label="Ayuda">
            <IconHelp />
          </button>
          <button className="prueba-icon-button" type="button" aria-label="Ajustes">
            <IconSettings />
          </button>
          <button className="prueba-profile" type="button" aria-label="Perfil">
            <span className="prueba-avatar" aria-hidden="true" />
            <span>Roberto</span>
            <IconChevron />
          </button>
        </div>
      ...
      <main className="prueba-main">
        <section className="prueba-editor">
          <div className="prueba-editor__glow" />
          <div className="prueba-editor__glow prueba-editor__glow--secondary" />
          <div className="prueba-pill-switch">
            <button className="is-active" type="button">Básica</button>
            <button type="button">Avanzada</button>
          </div>

          <div className="prueba-field">
            <label>Título</label>
            <div className="prueba-input">
          ...
          <div className="prueba-field">
            ...
            <div className="prueba-textarea">Descripción de la promoción...</div>
          </div>

          <div className="prueba-field">
            <label>Tipo de promoción</label>
            <div className="prueba-input prueba-input--select">
          ...
          <div className="prueba-field">
            ...
            <div className="prueba-group">
              <div className="prueba-condition-row">
                <div className="prueba-inline-icon"><IconPurchase /></div>
                <span>Compra</span>
                <FauxSelect text="2" width="70px" />
                <span className="prueba-inline-x">×</span>
                <FauxSelect text="1" width="58px" />
                <span>y lleva gratis</span>
              </div>
              <div className="prueba-condition-row">
                <div className="prueba-inline-icon"><IconGift /></div>
                <span>Gratis</span>
                <FauxSelect text="1" width="70px" />
                <div className="prueba-chip-input">Ejemplo: Refresco 350ml</div>
              </div>
            </div>
          </div>
          ...
          <div className="prueba-field">
            ...
            <div className="prueba-group prueba-group--stacked">
              <div className="prueba-benefit-row">
                <div className="prueba-inline-icon"><IconDiscount /></div>
                <span>Obtiene</span>
                <FauxSelect text="Segundo" width="114px" />
                <span>con</span>
                <div className="prueba-mini-input">20</div>
                <span>% de descuento</span>
                <button className="prueba-trash" type="button" aria-label="Eliminar"><IconTrash /></button>
              </div>
              <div className="prueba-benefit-row">
                <div className="prueba-inline-icon"><IconGift /></div>
                <span>Obtiene</span>
          ...
          <button className="prueba-add" type="button">
            <IconPlus />
            <span>Agregar beneficio</span>
          </button>

          <div className="prueba-actions">
            <div className="prueba-save-state">
              <span className="prueba-save-dot" />
              <span>Guardado hace 3 min</span>
            </div>
            <div className="prueba-actions__buttons">
              <button className="prueba-primary" type="button">
                <IconDoc />
                <span>Guardar borrador</span>
              </button>
              <button className="prueba-secondary" type="button">
                <IconPlane />
        ...
        <section className="prueba-preview-wrap">
          <div className="prueba-speed-switch">
            <button className="is-active" type="button">Normal</button>
            <button type="button">Rápida</button>
          </div>
          <a className="prueba-help-link" href="/prueba">¿Cómo elegir?</a>
          <div className="prueba-dots prueba-dots--left" />
          <div className="prueba-dots prueba-dots--right" />

          <article className="prueba-card">
            <div className="prueba-card__media"><IconImage /></div>
            <div className="prueba-card__body">
              <h1>Título</h1>
              <p>Descripción...</p>
              <div className="prueba-separator" />
              <section className="prueba-card__conditions">
                <h2>Condiciones de la promoción</h2>
                <div className="prueba-card__pill">
                  <IconCheck color="#13a66d" />
                  <span>
                    Compra <strong>2 Ejemplo</strong> y obtén el <strong>Tercer objeto gratis.</strong>
                  </span>
                </div>
                <div className="prueba-card__pill prueba-card__pill--alt">
                  <IconCheck color="#6846d8" />
                  <span><strong>20%</strong> de descuento en el Segundo objeto*</span>
                </div>
              </section>
              <div className="prueba-separator" />
              <div className="prueba-meta">
                <div className="prueba-meta__row">
                  <IconPin />

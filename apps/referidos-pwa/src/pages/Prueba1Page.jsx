...
function LogoMark() {
  return (
    <svg viewBox="0 0 57 44" aria-hidden="true">
      <defs>
        <linearGradient id="qrew-mark-prueba1" x1="3" x2="46" y1="5" y2="38" gradientUnits="userSpaceOnUse">
...
function FauxSelect({ text, width = "auto" }) {
  return (
    <div className="prueba1-select" style={{ width }}>
      <span>{text}</span>
      <IconChevron />
    </div>
  );
...
export default function Prueba1Page() {
  return (
    <div className="prueba1-page">
      <header className="prueba1-topbar">
        <div className="prueba1-topbar__left">
          <div className="prueba1-brand">
            <LogoMark />
            <span>Qrew</span>
          </div>
          <div className="prueba1-divider" />
          <div className="prueba1-title">Panel de promociones</div>
          <nav className="prueba1-mainnav" aria-label="Secciones">
            <a className="is-active" href="/prueba1">Crear</a>
            <a href="/prueba1">Gestionar</a>
            <a href="/prueba1">Métricas</a>
          </nav>
        </div>

        <div className="prueba1-topbar__right">
          <button className="prueba1-icon-button prueba1-notify" type="button" aria-label="Notificaciones">
            <IconBell />
            <span className="prueba1-badge">3</span>
          </button>
          <button className="prueba1-icon-button" type="button" aria-label="Ayuda">
            <IconHelp />
          </button>
          <button className="prueba1-icon-button" type="button" aria-label="Ajustes">
            <IconSettings />
          </button>
          <button className="prueba1-profile" type="button" aria-label="Perfil">
            <span className="prueba1-avatar" aria-hidden="true" />
            <span>Roberto</span>
            <IconChevron />
          </button>
        </div>
      ...
      <main className="prueba1-main">
        <section className="prueba1-editor">
          <div className="prueba1-editor__glow" />
          <div className="prueba1-editor__glow prueba1-editor__glow--secondary" />
          <div className="prueba1-pill-switch">
            <button className="is-active" type="button">Básica</button>
            <button type="button">Avanzada</button>
          </div>

          <div className="prueba1-field">
            <label>Título</label>
            <div className="prueba1-input">
          ...
          <div className="prueba1-field">
            ...
            <div className="prueba1-textarea">Descripción de la promoción...</div>
          </div>

          <div className="prueba1-field">
            <label>Tipo de promoción</label>
            <div className="prueba1-input prueba1-input--select">
          ...
          <div className="prueba1-field">
            ...
            <div className="prueba1-group">
              <div className="prueba1-condition-row">
                <div className="prueba1-inline-icon"><IconPurchase /></div>
                <span>Compra</span>
                <FauxSelect text="2" width="70px" />
                <span className="prueba1-inline-x">×</span>
                <FauxSelect text="1" width="58px" />
                <span>y lleva gratis</span>
              </div>
              <div className="prueba1-condition-row">
                <div className="prueba1-inline-icon"><IconGift /></div>
                <span>Gratis</span>
                <FauxSelect text="1" width="70px" />
                <div className="prueba1-chip-input">Ejemplo: Refresco 350ml</div>
              </div>
            </div>
          </div>
          ...
          <div className="prueba1-field">
            ...
            <div className="prueba1-group prueba1-group--stacked">
              <div className="prueba1-benefit-row">
                <div className="prueba1-inline-icon"><IconDiscount /></div>
                <span>Obtiene</span>
                <FauxSelect text="Segundo" width="114px" />
                <span>con</span>
                <div className="prueba1-mini-input">20</div>
                <span>% de descuento</span>
                <button className="prueba1-trash" type="button" aria-label="Eliminar"><IconTrash /></button>
              </div>
              <div className="prueba1-benefit-row">
                <div className="prueba1-inline-icon"><IconGift /></div>
                <span>Obtiene</span>
          ...
          <button className="prueba1-add" type="button">
            <IconPlus />
            <span>Agregar beneficio</span>
          </button>

          <div className="prueba1-actions">
            <div className="prueba1-save-state">
              <span className="prueba1-save-dot" />
              <span>Guardado hace 3 min</span>
            </div>
            <div className="prueba1-actions__buttons">
              <button className="prueba1-primary" type="button">
                <IconDoc />
                <span>Guardar borrador</span>
              </button>
              <button className="prueba1-secondary" type="button">
                <IconPlane />
        ...
        <section className="prueba1-preview-wrap">
          <div className="prueba1-speed-switch">
            <button className="is-active" type="button">Normal</button>
            <button type="button">Rápida</button>
          </div>
          <a className="prueba1-help-link" href="/prueba1">¿Cómo elegir?</a>
          <div className="prueba1-dots prueba1-dots--left" />
          <div className="prueba1-dots prueba1-dots--right" />

          <article className="prueba1-card">
            <div className="prueba1-card__media"><IconImage /></div>
            <div className="prueba1-card__body">
              <h1>Título</h1>
              <p>Descripción...</p>
              <div className="prueba1-separator" />
              <section className="prueba1-card__conditions">
                <h2>Condiciones de la promoción</h2>
                <div className="prueba1-card__pill">
                  <IconCheck color="#13a66d" />
                  <span>
                    Compra <span className="prueba1-card__tone">2 Ejemplo</span> y obtén el <span className="prueba1-card__tone">Tercer objeto gratis.</span>
                  </span>
                </div>
                <div className="prueba1-card__pill prueba1-card__pill--alt">
                  <IconCheck color="#6846d8" />
                  <span><span className="prueba1-card__accent">20%</span> de descuento en el Segundo objeto*</span>
                </div>
              </section>
              <div className="prueba1-separator" />
              <div className="prueba1-meta">
                <div className="prueba1-meta__row">
                  <IconPin />

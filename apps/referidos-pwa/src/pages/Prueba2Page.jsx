...
function LogoMark() {
  return (
    <svg viewBox="0 0 57 44" aria-hidden="true">
      <defs>
        <linearGradient id="qrew-mark-prueba2" x1="3" x2="46" y1="5" y2="38" gradientUnits="userSpaceOnUse">
...
function FauxSelect({ text, width = "auto" }) {
  return (
    <div className="prueba2-select" style={{ width }}>
      <span>{text}</span>
      <IconChevron />
    </div>
  );
...
export default function Prueba2Page() {
  return (
    <div className="prueba2-page">
      <header className="prueba2-topbar">
        <div className="prueba2-topbar__left">
          <div className="prueba2-brand">
            <LogoMark />
            <span>Qrew</span>
          </div>
          <div className="prueba2-divider" />
          <div className="prueba2-title">Panel de promociones</div>
          <nav className="prueba2-mainnav" aria-label="Secciones">
            <a className="is-active" href="/prueba2">Crear</a>
            <a href="/prueba2">Gestionar</a>
            <a href="/prueba2">Métricas</a>
          </nav>
        </div>

        <div className="prueba2-topbar__right">
          <button className="prueba2-icon-button prueba2-notify" type="button" aria-label="Notificaciones">
            <IconBell />
            <span className="prueba2-badge">3</span>
          </button>
          <button className="prueba2-icon-button" type="button" aria-label="Ayuda">
            <IconHelp />
          </button>
          <button className="prueba2-icon-button" type="button" aria-label="Ajustes">
            <IconSettings />
          </button>
          <button className="prueba2-profile" type="button" aria-label="Perfil">
            <span className="prueba2-avatar" aria-hidden="true" />
            <span>Roberto</span>
            <IconChevron />
          </button>
        </div>
      ...
      <main className="prueba2-main">
        <section className="prueba2-editor">
          <div className="prueba2-editor__glow" />
          <div className="prueba2-editor__glow prueba2-editor__glow--secondary" />
          <div className="prueba2-pill-switch">
            <button className="is-active" type="button">Básica</button>
            <button type="button">Avanzada</button>
          </div>

          <div className="prueba2-field">
            <label>Título</label>
            <div className="prueba2-input">
          ...
          <div className="prueba2-field">
            ...
            <div className="prueba2-textarea">Descripción de la promoción...</div>
          </div>

          <div className="prueba2-field">
            <label>Tipo de promoción</label>
            <div className="prueba2-input prueba2-input--select">
          ...
          <div className="prueba2-field">
            ...
            <div className="prueba2-group">
              <div className="prueba2-condition-row">
                <div className="prueba2-inline-icon"><IconPurchase /></div>
                <span>Compra</span>
                <FauxSelect text="2" width="70px" />
                <span className="prueba2-inline-x">×</span>
                <FauxSelect text="1" width="58px" />
                <span>y lleva gratis</span>
              </div>
              <div className="prueba2-condition-row">
                <div className="prueba2-inline-icon"><IconGift /></div>
                <span>Gratis</span>
                <FauxSelect text="1" width="70px" />
                <div className="prueba2-chip-input">Ejemplo: Refresco 350ml</div>
              </div>
            </div>
          </div>
          ...
          <div className="prueba2-field">
            ...
            <div className="prueba2-group prueba2-group--stacked">
              <div className="prueba2-benefit-row">
                <div className="prueba2-inline-icon"><IconDiscount /></div>
                <span>Obtiene</span>
                <FauxSelect text="Segundo" width="114px" />
                <span>con</span>
                <div className="prueba2-mini-input">20</div>
                <span>% de descuento</span>
                <button className="prueba2-trash" type="button" aria-label="Eliminar"><IconTrash /></button>
              </div>
              <div className="prueba2-benefit-row">
                <div className="prueba2-inline-icon"><IconGift /></div>
                <span>Obtiene</span>
          ...
          <button className="prueba2-add" type="button">
            <IconPlus />
            <span>Agregar beneficio</span>
          </button>

          <div className="prueba2-actions">
            <div className="prueba2-save-state">
              <span className="prueba2-save-dot" />
              <span>Guardado hace 3 min</span>
            </div>
            <div className="prueba2-actions__buttons">
              <button className="prueba2-primary" type="button">
                <IconDoc />
                <span>Guardar borrador</span>
              </button>
              <button className="prueba2-secondary" type="button">
                <IconPlane />
        ...
        <section className="prueba2-preview-wrap">
          <div className="prueba2-speed-switch">
            <button className="is-active" type="button">Normal</button>
            <button type="button">Rápida</button>
          </div>
          <a className="prueba2-help-link" href="/prueba2">¿Cómo elegir?</a>
          <div className="prueba2-dots prueba2-dots--left" />
          <div className="prueba2-dots prueba2-dots--right" />

          <article className="prueba2-card">
            <div className="prueba2-card__media"><IconImage /></div>
            <div className="prueba2-card__body">
              <h1>Título</h1>
              <p>Descripción...</p>
              <div className="prueba2-separator" />
              <section className="prueba2-card__conditions">
                <h2>Condiciones de la promoción</h2>
                <div className="prueba2-card__pill">
                  <IconCheck color="#13a66d" />
                  <span>
                    Compra <span className="prueba2-card__tone">2 Ejemplo</span> y obtén el <span className="prueba2-card__tone">Tercer objeto gratis.</span>
                  </span>
                </div>
                <div className="prueba2-card__pill prueba2-card__pill--alt">
                  <IconCheck color="#6846d8" />
                  <span><span className="prueba2-card__accent">20%</span> de descuento en el Segundo objeto*</span>
                </div>
              </section>
              <div className="prueba2-separator" />
              <div className="prueba2-meta">
                <div className="prueba2-meta__row">
                  <IconPin />

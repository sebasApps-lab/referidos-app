-- 20260222_000016_versioning_execute_deploy_started.sql
-- Allow started status for deploy execution and keep request executed while deployment is in progress

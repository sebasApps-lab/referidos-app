...
const featureCards = [
  {
    ...
    iconClassName: "landing-prueba2__feature-icon--gift",
    icon: <GiftIcon />,
  },
  {
    key: "puntos",
    ...
    description:
      "Invita a tus amigos, participa mÃ¡s cerca de ti y suma beneficios en cada recomendaciÃ³n.",
    iconClassName: "landing-prueba2__feature-icon--coins",
    icon: <CoinsIcon />,
  },
  {
    key: "progreso",
    ...
    highlight: "",
    description:
      "Incluye mÃ©tricas, niveles y seguimiento claro de tus recompensas desde una sola app.",
    iconClassName: "landing-prueba2__feature-icon--chart",
    icon: <ChartIcon />,
  },
];

export default function LandingPrueba2Page() {
  return (
    <main className="landing-prueba2" aria-label="Landing de prueba de Referidos App">
      <section className="landing-prueba2__hero">
        <div className="landing-prueba2__shell landing-prueba2__hero-shell">
          <div className="landing-prueba2__hero-copy">
            <div className="landing-prueba2__eyebrow">REFERIDOS APP</div>
            <h1 className="landing-prueba2__hero-title">
              Descubre y comparte
              <br />
              ofertas, gana
              <br />
              recompensas fÃ¡cilmente
            </h1>
            <p className="landing-prueba2__hero-body">
              Aprovecha promociones exclusivas, invita a tus amigos y gana puntos por cada
              recomendaciÃ³n exitosa.
            </p>
            <button className="landing-prueba2__download" type="button">
              <span>Â¡Descargar</span>
              <ChevronRightIcon />
            </button>
          </div>

          <div className="landing-prueba2__hero-visual" aria-hidden="true">
            <PhoneMockup />
            <AccountCard />
          </div>
        </div>
      ...
      <section className="landing-prueba2__features">
        <div className="landing-prueba2__shell landing-prueba2__features-shell">
          <div className="landing-prueba2__section-header">
            <h2>AsÃ­ de fÃ¡cil y divertido</h2>
            <p>
              Encuentra promociones exclusivas, gana puntos y haz un seguimiento de tus
              recompensas, Â¡todo desde <span>una app</span>!
            </p>
          </div>

          <div className="landing-prueba2__feature-grid">
            {featureCards.map((card) => (
              <article key={card.key} className="landing-prueba2__feature-card">
                <div className={`landing-prueba2__feature-icon ${card.iconClassName}`}>{card.icon}</div>
                <h3>
      ...
      <section className="landing-prueba2__cta">
        <div className="landing-prueba2__shell landing-prueba2__cta-shell">
          <div className="landing-prueba2__cta-copy">
            <h2>
            ...
            <div className="landing-prueba2__signup-row">
              <input aria-label="Tu correo electrÃ³nico" placeholder="Tu correo electrÃ³nico" />
              <button type="button">Crear cuenta gratuita</button>
            </div>

            <p className="landing-prueba2__legal-copy">
              Al registrarte, aceptas recibir noticias y comunicaciones.{" "}
              <span>Aviso de privacidad</span>
            </p>

            <div className="landing-prueba2__qr-row">
              <div className="landing-prueba2__qr-box">
                <QRCode value="https://referidos.app/landing-prueba2" size={84} />
              </div>
              <div>
...
function AccountCard() {
  return (
    <aside className="landing-prueba2__account-card">
      <h3>Crea tu cuenta gratis</h3>
      <button className="landing-prueba2__google-button" type="button">
        <GoogleIcon />
        <span>Continuar con Google</span>
      </button>
      <button className="landing-prueba2__primary-cta" type="button">
        <SparkIcon />
      ...
      <div className="landing-prueba2__account-shine" />
    </aside>
  );
}
...
function PhoneMockup() {
  return (
    <div className="landing-prueba2__phone">
      <div className="landing-prueba2__phone-glow" />
      <div className="landing-prueba2__phone-frame">
        <div className="landing-prueba2__phone-screen">
          <div className="landing-prueba2__phone-status">
            <span>9:1</span>
            <span>â—” â—” â—”</span>
          </div>

          <div className="landing-prueba2__phone-top">
            <div className="landing-prueba2__user">
              <div className="landing-prueba2__user-avatar" />
              <span>Lucia</span>
            </div>
            <div className="landing-prueba2__phone-icons">
              <BellMiniIcon />
              <PowerMiniIcon />
            </div>
          </div>

          <div className="landing-prueba2__phone-body">
            <div className="landing-prueba2__phone-brand">REFERIDOS APP</div>

            <article className="landing-prueba2__mobile-card">
              <div className="landing-prueba2__mobile-card-media">
                <BurgerArtwork />
                <div className="landing-prueba2__mobile-card-qr">
                  <QRCode value="https://referidos.app/urban-grill" size={58} />
                </div>
              </div>
              <div className="landing-prueba2__mobile-card-content">
                <h3>Combo burger + bebida</h3>
                <p>
                  Encuentra promos cerca de ti, Ãºnete a puntos y obtÃ©n beneficios en cada
                  visita.
                </p>
                <div className="landing-prueba2__mobile-meta">
                  <span>
                    <LocationIcon />
                    La Carolina, Calle B
                  </span>
                  <span className="landing-prueba2__mobile-pill">A domicilio</span>
                </div>
              </div>
            </article>
          </div>

          <div className="landing-prueba2__phone-nav">
...
function PromoStack() {
  return (
    <div className="landing-prueba2__promo-stack" aria-hidden="true">
      <div className="landing-prueba2__promo-event">
        <div className="landing-prueba2__promo-branding">Ayllu Rooftop</div>
        <div className="landing-prueba2__promo-event-content">
          <div className="landing-prueba2__promo-event-thumb">
            <ImageIcon />
          </div>
          <div>
            <h3>Happy hour mocktails</h3>
            <p>Dos bebidas por el precio de una.</p>
            <div className="landing-prueba2__promo-date">
              <CalendarDotIcon />
      ...
      <div className="landing-prueba2__promo-card">
        <div className="landing-prueba2__promo-card-copy">
          <h3>Urban Grill</h3>
          <p>MenÃº completo con bebida frÃ­a, a precio especial, por tiempo limitado.</p>
          <div className="landing-prueba2__promo-location">
            <LocationIcon />
            <span>La Carolina, Calle B</span>
          </div>
        </div>
        <div className="landing-prueba2__promo-card-qr">
...
function BurgerArtwork() {
  return (
    <div className="landing-prueba2__burger-art">
      <div className="landing-prueba2__burger-glow" />
      <div className="landing-prueba2__burger-top" />
      <div className="landing-prueba2__burger-lettuce" />
      <div className="landing-prueba2__burger-cheese" />
      <div className="landing-prueba2__burger-patty" />
      <div className="landing-prueba2__burger-bottom" />
      <div className="landing-prueba2__burger-stick" />
    </div>
  );
}

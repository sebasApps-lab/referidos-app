...
const featureCards = [
  {
    ...
    title: (
      <p className="anima-prototype__feature-title anima-prototype__feature-title--explora">
        ...
        <span className="anima-prototype__feature-title-gap">&nbsp;</span>
        <span className="anima-prototype__feature-title-medium">
          promociones
          <br />
          exclusivas
        </span>
    ...
    description: (
      <p className="anima-prototype__feature-description anima-prototype__feature-description--explora">
  ...
  },
  {
    ...
    title: (
      <p className="anima-prototype__feature-title anima-prototype__feature-title--puntos">
        ...
        <span className="anima-prototype__feature-title-break">
          <br />
        </span>
        <span className="anima-prototype__feature-title-medium">y recompensas</span>
      </p>
    ),
    description: (
      <p className="anima-prototype__feature-description anima-prototype__feature-description--wide">
...
export default function AnimaPrototypePage() {
  ...
  return (
    <main className="anima-prototype" aria-label="Anima prototype">
      <div className="anima-prototype__frame">
        <div className="anima-prototype__header" />

        <div className="anima-prototype__body">
          <AnimaAppIntroductionSection />
          <AnimaFeaturesHighlightSection />
          <AnimaSubscriptionCallToActionSection />
        </div>

        <div className="anima-prototype__footer" />
      </div>
    </main>
  );
}

function AnimaAppIntroductionSection() {
  return (
    <section className="anima-prototype__app-introduction">
      <div className="anima-prototype__app-introduction-bg" aria-hidden="true">
        <HeroBgVector />
      </div>

      <div className="anima-prototype__app-introduction-content">
        <div className="anima-prototype__hero-copy-block">
          <div className="anima-prototype__hero-brand">REFERIDOS APP</div>

          <div className="anima-prototype__hero-copy-group">
            <div className="anima-prototype__hero-text-group">
              <p className="anima-prototype__hero-title">
                Descubre y comparte <br />
                ofertas, gana <br />
                recompensas facilmente
              </p>

              <p className="anima-prototype__hero-description">
                Aprovecha promociones exclusivas, invita a tus <br />
                amigos y canda puntos por cada canje.
              </p>
            </div>

            <div className="anima-prototype__download-wrapper">
              <div className="anima-prototype__download-text">Descargar</div>
              <div className="anima-prototype__download-text">&gt;</div>
            </div>
          </div>
        </div>
        ...
        <div className="anima-prototype__hero-visual">
          ...
          <div className="anima-prototype__hero-signup-stack">
            <div className="anima-prototype__signup-card">
              <div className="anima-prototype__signup-card-asset" aria-hidden="true">
                <SignUpCardBgSvg />
              </div>

              <div className="anima-prototype__signup-title">Crea tu cuenta gratis</div>

              <div className="anima-prototype__signup-body-line">
                <div className="anima-prototype__signup-body-content">
                  <div className="anima-prototype__signup-button-group">
                    <div className="anima-prototype__signup-button anima-prototype__signup-button--google">
                      <GoogleIcon />
                      <div className="anima-prototype__signup-button-text anima-prototype__signup-button-text--google">
                        Continuar con Google
                      </div>
                    </div>

                    <div className="anima-prototype__signup-button anima-prototype__signup-button--mail">
                      <MailIcon />
                      <div className="anima-prototype__signup-button-text anima-prototype__signup-button-text--mail">
                        Continuar con correo
                      </div>
                    </div>
                  </div>

                  <div className="anima-prototype__signup-bottom">
                    <div className="anima-prototype__signup-bottom-copy">Ya tienes cuenta?</div>
                    <div className="anima-prototype__signup-bottom-link">Inicia sesi&oacute;n</div>
                  </div>
                </div>

                <div className="anima-prototype__signup-line" />
              </div>
            </div>
          </div>
        </div>
...
function AnimaFeaturesHighlightSection() {
  return (
    <section className="anima-prototype__features-highlight">
      <div className="anima-prototype__features-highlight-content">
        <div className="anima-prototype__features-heading">
          <div className="anima-prototype__features-heading-title">
            <div className="anima-prototype__features-heading-prefix">As&iacute; de</div>
            <div className="anima-prototype__features-heading-main">f&aacute;cil y divertido</div>
          </div>

          <p className="anima-prototype__features-heading-copy">
            <span className="anima-prototype__features-heading-copy-light">
              Encuentra promociones exclusivas gana puntos y haz un <br />
              seguimiento de tus recopensas, &iexcl;todo desde una misma{" "}
            </span>
            <span className="anima-prototype__features-heading-copy-medium">app!</span>
          </p>
        </div>

        <div className="anima-prototype__features-cards">
          {featureCards.map((feature) => (
            <div key={feature.key} className={`anima-prototype__feature-card ${feature.modifier}`}>
              <div className="anima-prototype__feature-card-shadow" />

              <div className="anima-prototype__feature-card-surface">
                {feature.title}
                {feature.description}
              </div>

              <div className="anima-prototype__feature-card-gradient" />
...
function AnimaSubscriptionCallToActionSection() {
  const [email, setEmail] = useState("");

  return (
    <section className="anima-prototype__subscription">
      <div className="anima-prototype__subscription-content">
        <div className="anima-prototype__subscription-copy-block">
          <p className="anima-prototype__subscription-title">
            <span className="anima-prototype__subscription-title-leading">P</span>
            <span className="anima-prototype__subscription-title-main">
              romociones irresistibles,
              <br />
              al alcance de tu mano
            </span>
          </p>

          <div className="anima-prototype__subscription-copy-group">
            <p className="anima-prototype__subscription-subtitle">
              Descubre y canjea las ofertas que mas te gusten!
            </p>

            <div className="anima-prototype__subscription-form-group">
              <div className="anima-prototype__subscription-input-row">
                <input
                  type="email"
                  value={email}
                  onChange={(event) => setEmail(event.target.value)}
                  placeholder="Tu correo electr&oacute;nico"
                  className="anima-prototype__subscription-input"
                />

                <button type="button" className="anima-prototype__subscription-button">
                  <span>Crear cuenta gratuita</span>
                </button>

                <div className="anima-prototype__subscription-button-glow" aria-hidden="true" />
              </div>

              <p className="anima-prototype__subscription-legal">
                <span>Al suscribirte, aceptas los </span>
                <span className="anima-prototype__subscription-legal-link">
        ...
        <div className="anima-prototype__subscription-promo-placeholder" />
      </div>
    </section>
  );
}
...
function MailIcon() {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true">
      <defs>
        <linearGradient id="animaPrototypeMail" x1="4" x2="19" y1="5" y2="19" gradientUnits="userSpaceOnUse">
          <stop stopColor="#FFC96C" />
          <stop offset="1" stopColor="#FEBB48" />
        </linearGradient>
      </defs>
      <path d="M5.5 6.5h13a1.5 1.5 0 0 1 1.5 1.5v8a2 2 0 0 1-2 2h-12a2 2 0 0 1-2-2V8a1.5 1.5 0 0 1 1.5-1.5Z" fill="url(#animaPrototypeMail)" />

...
-- Cambios mínimos y compatibles con seed/APP existentes:
--  - mantiene campos previos (emailConfirmado ...)
--  - añade id_auth (uuid) en usuarios para mapear auth.users.uid
--  - crea índices recomendados
--  - NO borra otras tablas fuera de la lista

-- Limpieza re-ejecutable cada vez
...
-- ============================================
-- Usuarios demo SOLO los necesarios
-- ============================================
insert into usuarios (id,email,password,role,nombre,apellido,telefono,emailConfirmado,fechaCreacion)
values
('USR_ADMIN','admin@gmail.com','admin','admin','Admin','Demo','0990000000',true,now()),
('USR_NEG_1','tienda@gmail.com','tienda','negocio','Negocio','Demo','0991110000',true,now()),
('USR_CLI_1','user@gmail.com','user','cliente','Cliente','Demo','0992220000',true,now());

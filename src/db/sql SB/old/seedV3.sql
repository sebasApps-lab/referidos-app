-- seed.sql
-- FINAL — seed re-ejecutable (destructivo). ejecuta después de schema.sql.
-- TRUNCATE asegura limpieza total de las tablas manejadas por la app.
-- NOTA: id_auth queda NULL; el script de migración (JS) creará usuarios en Auth y actualizará id_auth.
...
-- ============================================
insert into usuarios (id, id_auth, email, password, role, nombre, apellido, telefono, emailConfirmado, fechaCreacion)
values
  ('USR_ADMIN', null, 'admin@gmail.com', 'admin', 'admin', 'Admin', 'Demo', '0990000000', true, now()),
  ('USR_NEG_1', null, 'tienda@gmail.com', 'tienda', 'negocio', 'Negocio', 'Demo', '0991110000', true, now()),
  ('USR_CLI_1', null, 'user@gmail.com', 'user', 'cliente', 'Cliente', 'Demo', '0992220000', true, now());

-- file: seed.sql
-- FINAL — seed re-ejecutable (destructivo).
-- EJECUTAR: después de schema.sql.
-- NOTA: id_auth queda NULL; ejecutar migrate_auth_and_sync.js con SERVICE ROLE KEY para crear Auth users
--       y actualizar usuarios.id_auth. No guardamos contraseñas en la tabla (usar Supabase Auth).
...
-- ============================================
-- Usuarios demo (id_auth null; actualizar con migration script)
-- ============================================
-- ATENCIÓN: la columna password fue eliminada del schema (usar Supabase Auth).
insert into usuarios (id, id_auth, email, role, nombre, apellido, telefono, emailConfirmado, fechaCreacion)
values
('USR_ADMIN', null, '[admin@gmail.com](mailto:admin@gmail.com)', 'admin', 'Admin', 'Demo', '0990000000', true, now()),
('USR_NEG_1', null, '[tienda@gmail.com](mailto:tienda@gmail.com)', 'negocio', 'Negocio', 'Demo', '0991110000', true, now()),
('USR_CLI_1', null, '[user@gmail.com](mailto:user@gmail.com)', 'cliente', 'Cliente', 'Demo', '0992220000', true, now());

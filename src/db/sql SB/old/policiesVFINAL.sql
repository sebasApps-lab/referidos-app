-- policies.sql
-- FINAL — basado en tu archivo estable.
-- Se agregan únicamente: emailConfirmado requerido para crear QR/comentarios/escaneos/reportes
-- y CRUD de sucursales por el negocio dueño.
...
------------------------------------------------------
-- SUCURSALES (negocio dueño puede crear/editar/borrar)
------------------------------------------------------

-- INSERT: negocio dueño
...
------------------------------------------------------
-- PROMOS_SUCURSALES (solo admin via service_role)
------------------------------------------------------

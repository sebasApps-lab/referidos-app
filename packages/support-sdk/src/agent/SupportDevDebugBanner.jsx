...
export default function SupportDevDebugBanner({
  scope = "support",
  ...
  return (
    <div
      className={`fixed ${placementClass} ${zIndexClass} w-[360px] rounded-xl border border-[#d9d2ea] bg-white/95 p-3 text-[10px] text-slate-700 shadow-lg backdrop-blur`}
    >

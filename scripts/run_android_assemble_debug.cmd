...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%INNER_PS%" -AndroidDir "%ANDROID_DIR%" -GradleHome "%GRADLE_LOCAL_HOME%" -TimeoutSeconds %TIMEOUT_SECONDS% -AndroidUserHome "%ANDROID_USER_HOME%"
set "ERR=%ERRORLEVEL%"
